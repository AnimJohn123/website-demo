...
$fields = [
  'email' => $user_email,
  'amount' => $total * 100,
  'callback_url' => "http://localhost/mini%20project/verify.php",
  'metadata' => ["cancel_action" => "http://localhost/mini%20project/home.php"]
];
...
curl_setopt(
  ...
  CURLOPT_HTTPHEADER,
  array(
    "Authorization: Bearer sk_live_5cfc70c69704a0abe3d05ebbd8755f3a3bf08279",
